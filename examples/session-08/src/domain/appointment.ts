...
export type Canceled = Omit<Scheduled, "kind"> & Readonly<{ kind: "Canceled"; reason: string; canceledAt: string; followUpRequestedAt?: string }>;
...
export type CancelInput = Readonly<{ reason: string; now: string; followUpRequestedAt?: string }>;
