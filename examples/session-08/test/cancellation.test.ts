...
describe("Session 06 cancellation", () => {
  it("予約済みまたは受付済みだけをキャンセルし、終端状態を判定する", () => {
    ...
    const examining = Appointment.startExamination(checkedIn, VeterinarianId.schema.parse("44444444-4444-4444-8444-444444444444"), Timestamp.schema.parse("2026-08-30T06:30:00.000Z"));
